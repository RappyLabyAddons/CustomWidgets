...
3. It should open your Labymod addon directory; Paste the [Custom_Widgets.jar](https://github.com/RappyLabyAddons/CustomWidgets/releases/download/v0.0.9/Custom_Widgets.jar) in there.
4. Launch your Labymod client.

If you have any problems with the addon/have update ideas, feel free to
- Open an Issue [here](https://github.com/RappyLabyAddons/CustomWidgets/issues/new/choose)
  or
